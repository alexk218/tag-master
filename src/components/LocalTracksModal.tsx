					...
					<div className={styles.modalBody}>
						<div className={styles.messageSection}>
							<p className={styles.message}>
								Your playlist "<strong>{playlistName}</strong>" has been created with Spotify tracks.
								However, {localTracks.length} local tracks couldn't be added automatically.
							</p>
						</div>

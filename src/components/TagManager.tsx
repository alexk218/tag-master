...
const TagManager: React.FC<TagManagerProps> = ({
    ...
    const [newSubcategoryInputs, setNewSubcategoryInputs] = useState<{ [categoryId: string]: string }>({});
    ...
    const handleRemoveCategory = (categoryId: string) => {
        ...
        const confirm = window.confirm(`Are you sure you want to delete the category "${category.name}" and all its subcategories and tags?`);
        if (confirm) {
    ...
    const handleRemoveSubcategory = (categoryId: string, subcategoryId: string) => {
        ...
        const confirm = window.confirm(`Are you sure you want to delete the subcategory "${subcategory.name}" and all its tags?`);
        if (confirm) {
                                    ...
                                    <div className={styles.categoryContent}>
                                        ...
                                        <div className={styles.subcategoriesList}>
                                            {category.subcategories?.map((subcategory) => (
                                                <div key={subcategory.id} className={styles.subcategorySection}>
                                                    ...
                                                    >
                                                        <span className={`${styles.expandIcon} ${expandedSubcategories.includes(subcategory.id) ? styles.expanded : ''}`}>
                                                                    ...
                                                                    <div key={tag.id} className={styles.tagItem}>
                                                                        ...
                                                                        <div className={styles.tagActions}>
                                                                            <button
                                                                                ...
                                                                                onClick={() => handleRenameTag(category.id, subcategory.id, tag.id)}
                                                                            >
                                                                                Rename
                                                                            </button>
                                                                            <button
                                                                                className={`${styles.tagAction} ${styles.tagDelete}`}
                                                                                onClick={() => handleRemoveTag(category.id, subcategory.id, tag.id)}
                                                                            >
                                                                                Delete
                                                                            </button>
                                                                        </div>
                                        ...
                                        <div className={styles.addSubcategoryForm}>
                                            <input
                                                ...
                                                onChange={(e) => setNewSubcategoryInputs({
